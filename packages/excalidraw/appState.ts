...
> => {
  return {
    ...
    currentItemLineHeight:
      DEFAULT_LINE_HEIGHT as ExcalidrawTextElement["lineHeight"],
    ...
    questionElementSettings: {
      showQuestionCardBorder: true,
      showQuestionMetadataBadge: true,
      applyFrameMasterToNewQuestionFrames: false,
    },
    slideNotes: {},
    presentationStep: 0,
    animationProgress: 1,
...
>(config: { [K in keyof T]: K extends keyof AppState ? T[K] : never }) =>
  ...
  currentItemLineHeight: { browser: true, export: false, server: false },
  ...
  textEditorPendingStyle: { browser: false, export: false, server: false },
  ...
  snapHapticsEnabled: { browser: true, export: false, server: false },
